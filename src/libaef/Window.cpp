...
// Version     :
// Copyright   : Copyright 2013 Altera Games
// Description : Open an X11 Window and create rendering context
//============================================================================
...
int main(int argc, char *argv[]) {
 ...
 while(1) {
        ...
        if(xev.type == Expose) {
        	...
        	count = XLookupString(&xev.xkey, buffer, bufsize, &keysym, &compose);
